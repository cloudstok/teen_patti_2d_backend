...
class GenerateResults {
    ...
    getCardValues = (cards) => cards.map(c => c.val);
    getCardSuits = (cards) => cards.map(c => c.suit);
    ...
    determineWinner(handACards, handBCards) {
        ...
        if (hand1.rank > hand2.rank) {
            ...
            const suitRank = { "D": 1, "C": 2, "H": 3, "S": 4 }
...
console.log(JSON.stringify(new GenerateResults().getResult()));